...
--
-- Table structure for table `data_drainagechannels`
--

DROP TABLE IF EXISTS `data_drainagechannels`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `data_drainagechannels` (
...
--
-- Dumping data for table `data_drainagechannels`
--
